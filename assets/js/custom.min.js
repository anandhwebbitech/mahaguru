  ...
  var v = function (e) {
    ...
    P = function () {
      jQuery(".wishlist-link").on("click", function () {
        jQuery(
          '.product-description .nav-tabs button[data-bs-target="#wishlist-pane"]'
        ).tab("show");
      }),
        jQuery(".cart-btn").on("click", function () {
          jQuery(
            '.product-description .nav-tabs button[data-bs-target="#shopping-cart-pane"]'
          ).tab("show");
        });
    },
    q = function () {
    ...
    A = function () {
      jQuery("body").append(
        '<script id="DZScript" src="https://dzassets.s3.amazonaws.com/w3-global-2.0.js?token=W-84700e042f2cb80c0f06ac2902c8116e"></script>'
      );
    },
    L = function () {
      var t = 0;
    ...
    D = function () {
      ...
      e.on("mousemove", function (e) {
        let t = $(this).offset();
        var i =
            ((e.pageX - t.left) / $(this).width()) * 100 <= 100
              ? ((e.pageX - t.left) / $(this).width()) * 100
              : 100,
          n =
            ((e.pageY - t.top) / $(this).height()) * 100 <= 100
              ? ((e.pageY - t.top) / $(this).height()) * 100
              : 100;
        $(this)
          .find("img")
    ...
    N = function () {
      jQuery(".show-pass").on("click", function () {
        ...
        "password" == e.attr("type")
          ? (e.attr("type", "text"), jQuery(this).addClass("active"))
          : (e.attr("type", "password"), jQuery(this).removeClass("active"));
      });
    },
    R = function () {
      let e = new Date(),
            ...
            u = () => {
              void 0 != i &&
                ...
                document.querySelector(".p-action-click:hover")
                  ? ((e.style.borderColor = d("pointerColor")), (s = !0))
                  : ((e.style.borderColor = "white"), (s = !1)),
                ...
                (t.style.transform = `translate(${
                  o - (l ? d("ringClickSize") : d("ringSize"))
                }px, ${a - (l ? d("ringClickSize") : d("ringSize"))}px)`),
